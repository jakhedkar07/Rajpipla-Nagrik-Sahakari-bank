...
<div  className={styles.hh}>
   ...
   <div className={styles.cover}>
    ...
    <div className={styles.content}><img src='./images/HARISH GANDHI.png'/><h3>HARISH GANDHI</h3><p>Director</p><p>9428322939</p></div>
    ...
    <div className={styles.content}><img src='./images/PADMKANTBHAI.png'/><h3>PADMKANTBHAI</h3><p>Director</p><p>9726118166</p></div>
    <div className={styles.content}><img src='./images/NAISHDH PARMAR.png'/><h3>DR. NAISHDH PARMAR</h3><p>Director</p><p>9825048683</p></div>
    <div className={styles.content}><img src='./images/JIGNASHABEN PATEL(VC).png'/><h3>JIGNASHABEN PATEL</h3><p>Vice Chairman</p><p>7016747551</p></div>
    <div className={styles.content}><img src='./images/KALPANABEN.png'/><h3>KALPANABEN</h3><p>Director</p><p>7367468404</p></div>
